...
class Response():   
    ...
    def get_mime_type(self, path):
        ...
        # Return the guessed type or default based on extension
        if mime_type:
            return mime_type
    ...
    def prepare_content_type(self, mime_type='text/html'):
        ...
        if main_type == 'text':
            ...
            if sub_type == 'plain' or sub_type == 'css':
                ...
                # Handle other text types (xml, csv, etc.)
                base_dir = BASE_DIR+"static/"
...
#                "Cookie": "{}".format(reqhdr.get("Cookie", "sessionid=xyz789")), #dummy cooki
        ...
        #
	# self.auth = ...
                # CORS headers to allow cross-origin requests (needed for ngrok)
    ...
    def build_response(self, request):
        ...
        elif mime_type == 'text/css' or path.endswith('.css'):
        ...
        #
        # Extended support for other objects
        #
        else:
